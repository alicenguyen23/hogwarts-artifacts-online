...
public class WizardController {
    ...
    @PostMapping
    public Result addArtifact(@Valid @RequestBody WizardDto wizardDto) {
    ...
    @PutMapping("/{wizardId}")
    public Result updateArtifact(@PathVariable Integer wizardId, @Valid @RequestBody WizardDto wizardDto) {
    ...
    public Result assignArtifact(@PathVariable Integer wizardId, @PathVariable String artifactId) {
        this.wizardService.assignArtiafact(wizardId, artifactId);
