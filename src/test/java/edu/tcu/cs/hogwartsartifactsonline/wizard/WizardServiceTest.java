...
class WizardServiceTest {
    ...
    void testAssignArtifactSuccess() {
        ...
        // When
        this.wizardService.assignArtiafact(3, "1250808601744904192");
    ...
    @Test
    void testAssignArtifactErrorWithNonExistenceWizard() {
        // Given
        Artifact a = new Artifact();
        a.setId("1250808601744904192");
        a.setName("Invisibility Cloak");
    ...
    @Test
    void testAssignArtifactErrorWithNonExistenceArtifact() {
        // Given
